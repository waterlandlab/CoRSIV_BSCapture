...
"""%(os.path.basename(sys.argv[0]), __version__), formatter_class=RawTextHelpFormatter)
    ...
    def doHeatmaps(self):
        ...
        self.doOneHeatmap("odds-ratio.cumulative.report-haplotype-AS_DNAm-PCC-neg-over-pos.02252021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative.report-haplotype-glm-Q3Q4-over-Q1Q2.02252021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative.report-haplotype-glm-Q4-over-Q1.02252021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative.report-mQTL-Q3Q4-over-Q1Q2.02202021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative.report-mQTL-Q4-over-Q1.02202021.fdr_limit.0.1.xls")
	...
	# cumulative directional
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-genic-corsiv-vs-genic-naive-controls.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-all-corsiv-vs-all-tdmr.02272021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.corsivs-over-subset10k-450k.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.all-corsiv-vs-all-naive-controls.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-mQTL-Q4-over-Q1.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-mQTL-Q3Q4-over-Q1Q2.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-genic-corsiv-vs-nongenic-corsivs.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-genic-corsiv-vs-genic-tdmr.02242021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-genic-corsiv-vs-genic-subset-4641-450bk-200bp.022420211.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-negative-mQTL-over-positive-mQTL.02242021.fdr_limit.0.1.xls")

        self.doOneHeatmap("odds-ratio.cumulative-direction.report-haplotype-AS_DNAm-PCC-neg-over-pos.02252021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-haplotype-glm-Q3Q4-over-Q1Q2.02252021.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.cumulative-direction.report-haplotype-glm-Q4-over-Q1.02252021.fdr_limit.0.1.xls")
