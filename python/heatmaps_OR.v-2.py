...
"""%(os.path.basename(sys.argv[0]), __version__), formatter_class=RawTextHelpFormatter)
    ...
    def doHeatmaps(self):
        ...
        self.doOneHeatmap("odds-ratio.comparison-mQTL-neg-over-pos.cumulative.fdr_limit.0.1.xls")
        self.doOneHeatmap("odds-ratio.haplotype.neg_R2_over_pos_R2.cumulative.fdr_limit.0.1.xls")

        self.doOneHeatmap("odds-ratio.cumulative.report-genic-corsiv-vs-genic-subset-4641-450bk-200bp.fdr-10p.xls.fdr_limit.0.01.xls")
        self.doOneHeatmap("odds-ratio.cumulative.corsivs-over-subset10k-450k.fdr-10p.xls.fdr_limit.0.01.xls")
